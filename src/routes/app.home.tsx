        ...
        <>
          {style === "Interface 1" && (
            <div className="flex flex-col items-center text-center">
              <img src={robot.url} alt={active.name} className="size-56 rounded-full border-4 border-primary object-cover" style={imageStyle} />
          ...
          {style === "Interface 2" && (
            <div className="relative -mx-5 overflow-hidden rounded-b-[2.5rem] border-b border-primary/40">
              <img src={robot.url} alt={active.name} className="h-80 w-full object-cover" />
          ...
          {style === "Interface 3" && (
            <div className="grid grid-cols-[1.15fr_0.85fr] items-center gap-4 rounded-3xl border border-primary/30 bg-card/60 p-4 glow-ring">
              <img src={robot.url} alt={active.name} className="aspect-square w-full rounded-[2rem] border-4 border-primary object-cover" style={imageStyle} />
              <div>
          ...
          {style === "Interface 4" && (
            <div className="rounded-[2rem] bg-gradient-to-br from-sky-100 via-blue-200 to-primary p-5 text-slate-950 shadow-2xl">
              ...
              <img src={robot.url} alt={active.name} className="mx-auto mt-6 size-52 rounded-full border-8 border-white/80 object-cover shadow-2xl" />
